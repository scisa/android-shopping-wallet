...
public class DeleteForeverEmptyTrashConfirmationDialog extends ParentDialog{
    private OnConfirmationDeleteButtonListener listener;
    private Button yesButton;
    private Button noButton;

    public DeleteForeverEmptyTrashConfirmationDialog(Context context) {
        super(context);
    ...
    void setLayoutRessource() {
        this.layoutRessource = R.layout.delete_forever_confirmation_dialog_empty_trash;
    }
